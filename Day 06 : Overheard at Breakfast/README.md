...
**Difficulty:** Easy
**Category:** OSINT
**Tools Used:** IntelBase, CyberChef
...
![Leaked Discord-style conversation revealing the email and "G" hint](images/conversation.png)
...
![IntelBase search results showing the Gravatar account link](images/lambo-mail-osint.png)
...
![Lambo's Gravatar profile revealing the encoded string](images/lambo-gravatar.png)
...
![CyberChef successfully decoding the Base64 string to reveal the flag](images/decode-day6-flag.png)

## 🚩 Flag
*   **Flag:** `THM{REDACTED}`

## 💡 Key Takeaways
*   **Email Footprinting:** An email address is one of the most powerful pivots in OSINT. Tools like IntelBase (or Epieos in the real world) can instantly link a seemingly anonymous email to connected services, reviews, and profiles across the web.
